...
require_once("DAO/TimeEntryCriteriaDAO.php");

/**
 * The TimeEntryCriteria class extends TimeEntryDAOCriteria and is used
 ...
 * @version 1.0
 */
class TimeEntryCriteria extends TimeEntryCriteriaDAO
{
