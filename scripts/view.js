...
var view = {
	...
	ModelView: Backbone.View.extend({
		...
		/** render populates the container element with contents of the template */
		render: function(callbackBeforeDisplay) {
			...
			if (callbackBeforeDisplay && (typeof callbackBeforeDisplay == "function")){
				html = callbackBeforeDisplay(html);
			}
			
			$(this.el).html(html);
			
			// fancy checkbox buttons toggle
