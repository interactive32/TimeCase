...
require_once("DAO/ProjectCriteriaDAO.php");

/**
 * The ProjectCriteria class extends ProjectDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProjectCriteria extends ProjectCriteriaDAO
{
